...
public class uPowerSeries {
	...
	public static void main(String[] args) {
		//edit the parameter to get the number of terms in the form [coefficient, A^, B^, w^, 0]. The 0 was a placeholder in the algorithm, so it is negligible information. 
		uPwrSeries(50);
